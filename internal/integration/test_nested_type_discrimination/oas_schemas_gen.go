...
func (s *BinaryData) SetSize(val int) {
	s.Size = val
}
...
func (s *DataMessage) GetEncoding() string {
	return s.Encoding
}
...
func (s *DataMessage) SetEncoding(val string) {
	s.Encoding = val
}
...
// PostMessageOK is response for PostMessage operation.
...
func (s *StructuredData) GetSchema() string {
	return s.Schema
}
...
func (s *StructuredData) SetSchema(val string) {
	s.Schema = val
}
...
func (s *TextMessage) GetMessageType() string {
...
func (s *TextMessage) SetMessageType(val string) {
	s.MessageType = val
}
