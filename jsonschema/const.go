...
// Const is JSON Schema const validator description, see https://json-schema.org/draft/2019-09/json-schema-validation#rfc.section.6.1.3 for the full specification of this keyword.
