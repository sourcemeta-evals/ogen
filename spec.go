...
type PathItem struct {
	...
	// Query defines the QUERY HTTP method operation on this path, as specified in RFC 9110.
	Query *Operation `json:"query,omitempty" yaml:"query,omitempty"`
	// AdditionalOperations maps HTTP method names to operations for methods not covered by fixed fields.
